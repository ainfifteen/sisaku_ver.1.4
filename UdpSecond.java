...
public class UdpSecond {
	...
	ListenPacket1 lisner1;
	public void startListener()
	{
		try{
			lisner1 = new ListenPacket1(soc);
			Thread lisner_thread = new Thread(lisner1);
...
//ListenPacketクラス
//マルチキャストパケットを受信
class ListenPacket1 implements Runnable {
	MulticastSocket s = null;//初期化
	// コンストラクタマルチキャストスレッド受け取り
	public ListenPacket1(MulticastSocket soc){
		s = soc;
	}
